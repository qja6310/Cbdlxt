...
<body>
	...
	<form class="layui-form my-form" lay-filter="form">
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="pgNum" id="pgNum" class="layui-input" value="${project.pgNum }" style="width: 500px;">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label lwp"><em>*</em>评估名称</label>
			<div class="layui-input-block">
				<input type="text" name="pgName" id="pgName" value="${project.pgName }" class="layui-input" style="width: 500px;">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label lwp"><em>*</em>船舶装备名称</label>
			<div class="layui-input-block">
				<input type="text" name="jczbName" id="jczbName" value="${project.jczbName }" class="layui-input" style="width: 500px;">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label lwp"><em>*</em>船舶装备代号</label>
			<div class="layui-input-block">
				<input type="text" name="jczbNum" id="jczbNum" value="${project.jczbNum }" class="layui-input" style="width: 500px;">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label lwp"><em>*</em>评估描述</label>
			<div class="layui-input-block">
				<textarea placeholder="请输入内容" class="layui-textarea" id="pgDesc" style="width: 500px;">${project.pgDesc }</textarea>
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-inline">
				<button type="button" class="layui-btn" onclick="doEdit()" style="margin: 0 0 0 100px;"><i class="layui-icon layui-icon-ok-circle"></i> 确定</button>
			</div>
		</div>
	...
	<script type="text/javascript">
		function doEdit(){
			...
			$.ajax({
				type : "post",
				url : "<%=request.getContextPath() %>/project/doEdit",
				data : {
					"id" : id,
					"pgNum" : pgNum,
					"pgName" : pgName,
